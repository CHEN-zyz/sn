...
const PV_CAM = [
  { t: 0, pos: [0, 2.0, 10], tgt: [0, 0, 0] },
  { t: 4, pos: [0, 1.2, 5.0], tgt: [0, 0, 0] },
  { t: 8, pos: [0.6, 1.4, 4.5], tgt: [0, 0.1, 0] },
  { t: 9, pos: [-1.2, 1.0, 4.5], tgt: [-2.2, -0.1, 0.5] },
  { t: 12, pos: [-0.3, 1.3, 5.0], tgt: [0, 0, 0] },
  { t: 13, pos: [1.0, 1.1, 4.5], tgt: [2.0, 0.1, -0.3] },
  { t: 15.5, pos: [0, 1.5, 6.5], tgt: [0, 0, 0] },
  { t: 18, pos: [0, 1.8, 8.0], tgt: [0, 0, 0] },
  { t: 22, pos: [0, 2.0, 9.5], tgt: [0, 0, 0] },
]
